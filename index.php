...
?>
    ...
    <div class="container-fluid">
	  <div class="row">
		<div class="col-lg-2 bg-dark text-white btn-md btn-block">
		<h1 class="my-4"></h1>
			<div class="nav flex-column nav-pills text-center" id="v-pills-tab" role="tablist" aria-orientation="vertical">
			<a class=" nav-link btn btn-success " id="v-pills-item-tab" data-toggle="dropdown" role="tab">Dashboard</a>
			  <a class=" nav-link btn btn-success " id="v-pills-item-tab" data-toggle="dropdown" role="tab">Item</a>
<div class="dropdown-menu">
			  <a class="navbar-dark navbar-nav nav-link  dropdown-item " data-toggle="tab" href="#itemDetailsTab">Item</a>
			  <a class="nav-link dropdown-item" data-toggle="tab" href="#itemImageTab"><span class="glyphicon glyphicon-asterisk "></span>Upload Image</a>
			  </div>
			  <a class="nav-link text-white  " id="v-pills-purchase-tab" data-toggle="pill" href="#v-pills-purchase" role="tab" aria-controls="v-pills-purchase" aria-selected="false"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true">Purchase</a>
			  <a class="nav-link text-white" id="v-pills-vendor-tab" data-toggle="pill" href="#v-pills-vendor" role="tab" aria-controls="v-pills-vendor" aria-selected="false"><span class="glyphicon glyphicon-tasks" aria-hidden="true">Vendor</a>
			  <a class="nav-link text-white" id="v-pills-sale-tab" data-toggle="pill" href="#v-pills-sale" role="tab" aria-controls="v-pills-sale" aria-selected="false"> <span class="glyphicon glyphicon-tasks" aria-hidden="true"></span> Sale</a>
			  <a class="nav-link text-white " id="v-pills-customer-tab" data-toggle="pill" href="#v-pills-customer" role="tab" aria-controls="v-pills-customer" aria-selected="false"><span class="glyphicon glyphicon-qrcode" aria-hidden="true">Customer</a>
			  <a class="nav-link text-white" id="v-pills-search-tab" data-toggle="pill" href="#v-pills-search" role="tab" aria-controls="v-pills-search" aria-selected="false"><span class="glyphicon glyphicon-th-large" aria-hidden="true">Search</a>
			  <a class="nav-link text-white" id="v-pills-reports-tab" data-toggle="pill" href="#v-pills-reports" role="tab" aria-controls="v-pills-reports" aria-selected="false"><span class="glyphicon glyphicon-pencil" aria-hidden="true">Reports</a>
			</div>
		</div>
		 <div class="col-lg-10">
			  ...
			  <div class="tab-pane fade show active" id="v-pills-item" role="tabpanel" aria-labelledby="v-pills-item-tab">
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">
					...
					<!-- Tab panes for item details and image sections --><div class="card-header">Item Details</div>
				  ...
				  <div class="card-body">										
					...
					<div class="tab-content">
						<div id="itemReportsTab" class="container-fluid tab-pane active">
							...
							<div class="table table-striped" id="itemReportsTableDiv"></div>
						</div>
						<div id="customerReportsTab" class="container-fluid tab-pane fade">
							<br>
							<p>Use the grid below to get reports for customers</p>
							<div class="table table-striped" id="customerReportsTableDiv"></div>
						</div>
						<div id="saleReportsTab" class="container-fluid tab-pane fade">
							...
							<br><br>
							<div class="table table-striped" id="saleReportsTableDiv"></div>
						</div>
						<div id="purchaseReportsTab" class="container-fluid tab-pane fade">
							...
							<br><br>
							<div class="table table-striped" id="purchaseReportsTableDiv"></div>
						</div>
						<div id="vendorReportsTab" class="container-fluid tab-pane fade">
							<br>
							<p>Use the grid below to get reports for vendors</p>
							<div class="table table-striped" id="vendorReportsTableDiv"></div>
						</div>
					</div>
				  </div> 
				</div>
